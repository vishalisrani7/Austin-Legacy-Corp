...
export default function DecryptedText({
  ...
  return (
    <motion.span
      ref={containerRef}
      className={`inline-block whitespace-pre-wrap jetbrains ${parentClassName}`}
      style={{ fontFamily: '"JetBrains Mono", monospace' }} // FORCE FONT HERE
      {...props}
    >
